...
export default {
  ...
  methods: {
    ...
    renderMoreFilters() {
      return (
        ...
        >
          ...
          <i
            class={
              this.localVisible ? "el-icon-arrow-up" : "el-icon-arrow-down"
            }
          ></i>
        </el-button>
      );
    ...
    initialArrowOffset() {
      ...
      if (!moreBtnEl) return;
      const filterWrapLeft =
        this.$el.querySelector(".filters-detail").offsetLeft;
    ...
    return (
      <div class="elfin-filters-root">
        <div class="outer-section">
          {this.$slots.outer && this.$slots.outer()}
